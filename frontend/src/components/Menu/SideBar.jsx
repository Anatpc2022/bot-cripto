        ...
        <nav id="sidebarMenu" className="sidebar d-lg-block bg-gray-800 text-white" data-simplebar>
            <div className="sidebar-inner px-4 pt-3">
                <ul className="nav flex-column pt-3 pt-md-0">
                    <li className="nav-item">
                        <a href="/dashboard" className="nav-link d-flex align-items-center">
                            <span className="sidebar-icon">
                                <img src="/img/favicon/favicon-32x32.png" height="32" width="32" alt="RiberBot Logo" />
                            </span>
                            <span className="mt-1 ms-1 sidebar-text">RiberBot</span>
                        </a>
                    </li>
                    ...
                    <SideBarItem to="/orders" text="Pedidos" >
                        <svg className="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SideBarItem to="/ordertemplates" text="Templates de Pedido">
                        <svg className="icon icon-xs me-2" fill="currentColor" strokeWidth="0" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <SideBarItem to="/monitors" text="Monitores">
                        <svg className="icon icon-xs me-2" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <SideBarItem to="#" text="Sair" onClick={btnLogoutClick}>
                        <svg className="icon icon-xs me-2" fill="none" strokeWidth="2.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
